				...
				<ClickableBlock>
					<div className='mx-6 relative'>
						<div className='group grid grid-cols-4 items-center hover:bg-regal-blue-hover  bg-regal-blue rounded-full py-4 px-12'>
							...
							<div className='absolute opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200 left-0 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-red flex justify-center items-center'>
